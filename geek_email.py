    ...
    try:
        ...
        try:
            if fullname.encode("utf-8").lower()==name.encode("utf-8").lower():
                ...
                list_remove=[' (s)',' (sea)',' (singapore)',' (pte)','(s)','(sea)','(singapore)','(pte)',' pte',' ltd','pte','ltd',' private',' limited','private','limited',',','.']
